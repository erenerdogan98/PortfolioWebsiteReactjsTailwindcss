        ...
        dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8">
            ...
            <div className="w-full flex justify-between items-center lg:hidden">
                <nav>
                    ...
                    <CustomLink href="/myskills" title="My Skills" className="mx-4" />
                    <CustomLink href="/articles" title="Articles" className='ml-4' />
                </nav>
                <nav className="flex items-center justify-center flex-wrap">
                    <motion.a href="https://twitter.com/phenomenalon6" target={"_blank"} 
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                        className="w-6 mx-3"
                    >
                    ...
                    <motion.a href="https://github.com/erenerdogan98" target={"_blank"}
                    ...
                    <motion.a href="https://www.linkedin.com/in/eren-erdogan-683815274/" target={"_blank"}
                        className="w-6 mx-3"
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                    >
